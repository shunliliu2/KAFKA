...
// * 对剧头物料的操作
// */
//public class Server_wl2 {
//    public void insertziji(Standard_media_assets new_standard_media_assets,String parentCode,String NumberCollection){
...
//            String sql = "insert into wuliaotest (itemId,name,originalname,sortname,searchname,actordisplay,originalcountry,language,orgairdate,licensingwindowstart,licensingwindowend,description,pricetaxin,kpeople,director,scriptwriter,compere,guest,reporter,opincharge,seriesflag,volumcpunt," +
...
//            System.out.println("new_standard_media_assets = " + new_standard_media_assets.getSeriestype());
...
//            System.out.println("selectwulio.getDb_score() = " + selectwulio.getDb_score());
//            try {
...
//            ps.setString(53,NumberCollection);
//            ps.setString(54,parentCode);
//            ps.executeUpdate();
//            inserturlziji(new_standard_media_assets.getItemId(),parentCode,NumberCollection,new_standard_media_assets.getDuration(),new_standard_media_assets.getTitle());
//
//
//
//
...
//     * @param code
//     */
//    public void inserturlziji(String code,String parentCode,String number,String duration,String title){
//        Connection conn = null;
//        PreparedStatement ps = null;
//        FileInputStream in = null;
//        int rowCount = 0;
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "select * from  wuliaotest where itemId = ?";
//            ps = conn.prepareStatement(sql);
...
//
//
//                user.setItemSetId(121);
//                user.setPublisherId(rs.getString(30));
//                user.setItemStatus("1");
//                user.setCoverUrl("");
//                user.setCollection(number);
//                user.setServerCode(parentCode);
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "delete from   wuliaotest where  itemId=?";
//            ps = conn.prepareStatement(sql);
//            ps.setString(1, code);
//            ps.executeUpdate();
//        } catch (Exception e) {
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "select hou_tag,region,db_score,hu_score,video_type,short_desc ,biao1,biao2,biao3,biao4,biao5,url from  wuliaotest where itemId = ?";
//            ps = conn.prepareStatement(sql);
//            ps.setString(1,code);
//            ResultSet rs = ps.executeQuery();//获得查询结果
//            while(rs.next()) {
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "update  wuliaotest set itemStatus='0' where itemId=?";
//            ps = conn.prepareStatement(sql);
//            ps.setString(1, code);
//            ps.executeUpdate();
//        } catch (Exception e) {
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "update  wuliaotest set itemStatus='1' where itemId=?";
//            ps = conn.prepareStatement(sql);
//            ps.setString(1, code);
//            ps.executeUpdate();
//        } catch (Exception e) {
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "update  wuliaotest set url=? where itemId=?";
//            ps = conn.prepareStatement(sql);
//            ps.setString(1,url);
//            ps.setString(2, code);
//            ps.executeUpdate();
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "select * from  wuliaotest where programcode = ?";
//            ps = conn.prepareStatement(sql);
//
//            ps.setString(1,code);
//            ResultSet rs = ps.executeQuery();//获得查询结果
...
//        HttpPost httpPost = new HttpPost("http://172.25.3.107:30000/cess-data-13/data/api/data-access/13/"+121+"/items");
...
//        try {
//            conn = ConnUtil.getConn();
//            String sql = "update  wuliaotest set linkurl=? where itemId=?";
//            ps = conn.prepareStatement(sql);
//            ps.setString(1,url);
//            ps.setString(2, code);
//            ps.executeUpdate();
